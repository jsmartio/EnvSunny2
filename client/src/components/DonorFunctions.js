...
export const updateDonorsSQL = (ids,newVals,fields,theToken) => {
  ...
  return axios
    .post('/donors/updatesqldonors2', jo)
    .then(res => {
      return res.data
    })
    .catch(err => {
