...
export const JSONtext = (props) => {
  ...
  if(props.playListLayoutIdsStr !== null && props.playListLayoutIdsStr !== undefined){
    ...
    stringArray.forEach( (e) => {
      layouts += createLayout(e, props.layoutsArr,o)
    })
    ...
    "playlist": [
      {
        ...
        "transition": {
          ...
          "Asset": "${o.global.dropBoxPath + props.playListObj.asset}"
        },
        "id": ${props.playListObj.idp},
        "layout": "${props.playListObj.layout}",
        "bgMovie": "${o.global.dropBoxPath + props.playListObj.bgMovie}",
